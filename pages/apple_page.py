...
class Apple_Page(Base):
    ...
    warranty_1_year = '(//span[@class="e9gxmdn0 app-catalog-2s5ps0-Wrapper--StyledWrapper-Checkbox--StyledCheckboxComponent enxkrel0"])[45]'
    ...
    phone_1_price = '(//div[@class="app-catalog-162o4kn-MainPrice--StyledMainPrice e2k4mew0"])[1]'
    phone_2 = '(//div[@class="app-catalog-1p7hp34-Flex--StyledFlex-Name--StyledName ezwjdcp0"])[2]'
    phone_2_price = '(//div[@class="app-catalog-162o4kn-MainPrice--StyledMainPrice e2k4mew0"])[2]'
    phone_3 = '(//div[@class="app-catalog-1p7hp34-Flex--StyledFlex-Name--StyledName ezwjdcp0"])[3]'
    phone_3_price = '(//div[@class="app-catalog-162o4kn-MainPrice--StyledMainPrice e2k4mew0"])[3]'
